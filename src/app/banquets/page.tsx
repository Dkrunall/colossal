    ...
    <div className="bg-[#050505] text-[#f7f3eb]">
      ...
      <section className="py-24 md:py-32 border-b border-[#1c1916]">
        <div className="mx-auto max-w-[1560px] px-6 md:px-12">
            ...
            {SPACE_TYPES.map((space) => (
              ...
              >
                <div>
                  ...
                  <div className="mt-6">
                    <span className="rounded-full border border-[#dfc18a]/30 bg-[#0e0d0c]/90 px-3.5 py-1 text-[0.65rem] font-bold uppercase tracking-[0.18em] text-[#dfc18a]">
                      {space.capacity}
                    </span>
                    <h3 className="font-luxury text-2xl font-normal tracking-[0.04em] text-[#f7f3eb] transition-colors group-hover:text-[#dfc18a] mt-3">
                      {space.title}
                    </h3>
          ...
          <div className="mt-20 rounded-[2.5rem] border border-[#26221c] bg-[#11100f] p-8 md:p-14 shadow-2xl">
            <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-6">
                <span className="text-[0.68rem] font-bold uppercase tracking-[0.26em] text-[#dfc18a]">
                  PRIVATE EVENT CONCIERGE
                </span>
                <h3 className="font-luxury text-3xl sm:text-4xl font-normal tracking-[0.02em] text-gold-gradient mt-2">
                  TAILOR YOUR OCCASION.
                </h3>
                <p className="mt-3 text-xs sm:text-sm text-[#b0a89d] leading-relaxed font-light max-w-lg">
                    ...
                    {EVENT_TYPES.map((evt) => (
                      <button
                        ...
                        className={`rounded-full px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] transition-all duration-300 cursor-pointer ${
                          selectedEvent === evt
                            ? "bg-[#dfc18a] text-black shadow-[0_0_15px_rgba(223,193,138,0.4)]"
                            : "border border-[#38332c] bg-[#1a1815] text-[#b0a89d] hover:border-[#dfc18a]/60 hover:text-white"
                        }`}
                      >
                        {evt}
                      </button>
              ...
              <div className="lg:col-span-6 rounded-2xl border border-[#3a342d] bg-[#171513] p-6 sm:p-8 space-y-5">
                <div className="border-b border-[#26221c] pb-4">
                  <p className="text-[0.62rem] font-bold uppercase tracking-wider text-[#736b60]">
                    Selected Occasion
                  </p>
                  <p className="font-luxury text-xl font-normal text-[#f7f3eb] mt-1">
                    {selectedEvent}
                  </p>
                </div>
                ...
                <p className="text-xs text-[#b0a89d] leading-relaxed font-light">
                  Includes dedicated sommelier, custom printed menus, private entrance option, and bespoke audio-visual setup.
                </p>

                <Link
                  href="/contact"
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-full border border-[#dfc18a] bg-[#dfc18a] py-3.5 text-xs font-bold uppercase tracking-[0.2em] text-black shadow-lg transition-all duration-300 hover:bg-[#f2dbab] hover:scale-[1.02]"
                >
